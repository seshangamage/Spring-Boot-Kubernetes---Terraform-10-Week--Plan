...
Week 1: Kubernetes & Docker foundations
 ...
 Day 4: Container registry: push image to Docker Hub / ECR / GHCR.
 Day 5: ConfigMaps & Secrets usage in K8s. Hands-on with env vars.
 ...
 Week 2: K8s advanced & Observability
 ...
 Day 12: Introduction to Prometheus + Grafana, instrument Spring Boot with Micrometer.
 ...
 Day 30: Terraform EKS module use (terraform-aws-modules/eks/aws) – sample apply to dev account.
...
Day 37: Build pipeline: build JAR, run tests, build Docker image, push to registry.
 Day 38: Deploy pipeline step: apply Terraform (using remote state) or use kubectl apply.
